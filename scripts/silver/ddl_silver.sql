...
-- if "silver.crm_cust_info" table exit then drop
...
GO
-- if "silver.crm_prd_info" table exit then drop
...
GO
-- if "silver.crm_sales_details" table exit the drop
...
GO
-- if "silver.erp_loc_a101" table exit then drop
...
GO
-- if "silver.erp_cust_az12" table exit then drop
...
GO
-- if "silver.erp_px_cat_g1v2" table exit then drop
